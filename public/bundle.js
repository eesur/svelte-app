...
function create_main_fragment(state, component) {
	var text, div, text_2, hr, text_3, h1, text_5, section;

	var header = new Header({
		_root: component._root,
		data: { title: state.settings.title }
	});
	...
	return {
		...
		p: function update(changed, state) {
			var header_changes = {};
			if (changed.settings) header_changes.title = state.settings.title;
